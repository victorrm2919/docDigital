<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3 bgBlueGradient" id="sidenav-main">
    <div class="sidenav-header">
      <i class="fas fa-times p-3 cursor-pointer text-white opacity-5 position-absolute right-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
      <a class="navbar-brand m-0" href="#">
        <img src="../platform/assets/img/logo-invertido.png" class="navbar-brand-img d-block m-auto" alt="...">
        <!-- <span class="ms-1 font-weight-bold text-white">DocDigital</span> -->
      </a>
    </div>
    <hr class="horizontal dark mt-0">
    <div class="collapse navbar-collapse overflow-hidden w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav navsid">
        <li class="nav-item">
          <a class="nav-link active hvr-sweep-to-left" href="../pages/dashboard.html">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center bgBlue">
        ...
        <li class="nav-item">
          <a class="nav-link hvr-sweep-to-left" href="../pages/tables.html">
        ...
        <li class="nav-item">
          <a class="nav-link hvr-sweep-to-left" href="../pages/billing.html">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link hvr-sweep-to-left" href="../pages/rtl.html">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
