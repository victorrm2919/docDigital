<?php include '../platform/functions/sessions.php' ?>
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="#">
        <!-- <img src="../platform/assets/img/logo.png" class="navbar-brand-img h-100 w-15" alt="..."> -->
        <span class="ms-1 font-weight-bold">DocDigital</span>
      </a>
    </div>
      ...
      <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            ...
            <li class="nav-item px-2 d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body p-0 closeSession">
          ...
          <div class="row align-items-center justify-content-lg-between">
            ...
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="#" class="nav-link text-muted" target="_blank">Sactiva</a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link text-muted" target="_blank">Acerca De</a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link text-muted" target="_blank">ONU</a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link pe-0 text-muted" target="_blank">Aviso de privacidad</a>
                </li>
              </ul>
            </div>
          </div>
